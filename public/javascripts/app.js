...
module.exports = ShotGridView = (function(_super) {
  ...
  ShotGridView.prototype.initialize = function() {
    ...
    this.delegate("click", ".super-button", this.loadNextPortion);
...
buf.push("<div class=\"shot-grid-view\"><div class=\"container\"><div class=\"shot-grid\"></div><div class=\"text-center\"><a class=\"super-button\">Загрузить еще</a></div></div></div>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
